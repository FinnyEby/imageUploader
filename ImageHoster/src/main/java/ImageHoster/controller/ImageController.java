...
public class ImageController {
    ...
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        int ownerId = image.getUser().getId();
        User user = (User) session.getAttribute("loggeduser");
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, Model model, HttpSession session) {
        ...
        if(ownerId == userId) {
            List<Comment> comments = commentService.getImageComments(imageId);
            commentService.deleteImageComments(comments);
    ...
    private String createComments(@RequestParam(name = "comment") String text, @PathVariable(name = "imageId") int imageId, Model model, HttpSession session) {
        if(text.isEmpty()) return "images/image";
        else {
